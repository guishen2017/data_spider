...
from data_spider.items import PolygonItem


class PolygonSpider(scrapy.Spider):
    name = 'polygon'
    allowed_domains = ['polygon.com']
    start_urls = "https://www.polygon.com/archives/news/{date}"
    logger = logging.getLogger(__name__)

    def start_requests(self):
        date_list = get_date_list(start_str="2012-01-01")
    ...
    def parse_item(self, response):
        try:
            ...
            item = PolygonItem(spider_name=spider_name, content=content, images_urls=images_urls, video_urls=video_urls,
